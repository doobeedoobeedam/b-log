            ...
            <div class="card detail-post border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text border-top pt-2 d-flex flex-wrap">
                        <small class="text-muted me-3"><i class="fas fa-calendar-alt me-1"></i> Last updated 3 mins ago</small>
                ...
                @foreach ($categories as $category)
                    <div class="post border-bottom mt-2 mb-3 pb-1 d-flex">
                        <div class="caption-img">
                            ...
                            @else
                            <img src="https://source.unsplash.com/1200x600?{{ $category->category->name }}" class="card-img-top img-fluid" alt="{{ $post->title }}">
                            @endif
                        </div>
                        <div class="caption card-body">
                            <p class="card-text">
                                <small class="text-muted">
                                    <a href="/posts?category={{ $category->category->slug }}" class="text-primary text-decoration-none">{{ $category->category->name }}</a> - 
